...
<head>
    ...
    <script src='{relativePath}/javascript/barplotData3FcPval.js'></script>
    ...
    <script src="{relativePath}/javascript/navyData3.js"></script>
    <script>
    ...
    <div class="column-position">
        ...
        <div >
            <select id="app-cover" onchange="categoryChange(this)">
                    <option value="volcano">Bar plot (FC & Pval) </option>
            </select>
