...
<head>
    ...
    <script src="{relativePath}/javascript/inchlibMain.js"></script>
    ...
    <script src="{relativePath}/javascript/navy.js"></script>
    <script>
...
<body>
    ...
    <div class="column-position">
        ...
        <div >
            ...
            <div id='volcano_myDiv'>
                <script>volcanoPlotMain(readJson);</script>
            </div>
            <div id='scatter_myDiv' class='visibility'>
    ...
    <nav class="nav">
        <ul class="nav__list">
            ...
            <div>
                <li style="font-size: 5px">pValue</li>
                <li class="rawPval">pValue</li>
            </div>
        </ul>
    </nav>
    <script
