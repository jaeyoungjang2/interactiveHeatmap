class Data3HtmlReportWithoutPval:
    def __init__(self):
        self.goDescription = ""
    ...
    def writeLabelColumn(self, DegGroupDic):
        self.labelDescription += f'''
            ...
            '''
        data3File = list(DegGroupDic.keys())[0]
        for degGroup in DegGroupDic[data3File]:
            ...
            <li>
                <a href="#">
                    <div style="display: flex; align-items: center; justify-content: space-between; ">
                    <span class="icon"><i class="fa-type fas fa-users"></i></span>
                    <span><a href="./html/{degGroup}.html">{degGroup}</a></span>
                    </div>
                </a>
            </li>
            '''
    ...
    def makeHtmlReport(self, fileName, DEG_group, htmlType):
        if htmlType.lower() == "main":
            relativePath = "."
        if htmlType.lower() == "sub":
            relativePath = ".."
...
<head>
    ...
    <script src="{relativePath}/javascript/inchlibMainData3.js"></script>
    <script src='{relativePath}/javascript/volcano_plotly_mod.js'></script>
    <script src='{relativePath}/javascript/barplotData3.js'></script>
    <script src='{relativePath}/javascript/barplotData3Fc.js'></script>
    ...
    <script src="{relativePath}/javascript/navyData3WithOutPval.js"></script>
    <script>
    ...
    <div class="column-position">
        ...
        <div >
            <select id="app-cover" onchange="categoryChange(this)">
                    <option value="volcano">Bar plot (Fold change)</option>
            </select>
            <div id='barplot_myDiv2' style='margin-bottom: 50px;'>
                <script>barplotData3Main(readJson);</script>
            </div>
