function runinchlib(file) {
    ...
    $(document).ready(function() { //run when the whole page is loaded
        ...
        inchlib.events.row_onmouseover = function(ids, evt){
            ...
            [volcanoHoverColor, index] = volcano_paintImage(ids, volcanoHoverColor);
            [scatterHoverColor, index] = scatter_paintImage(ids);
        ...
        inchlib.events.row_onmouseout = function(){
            ...
            volcano_unpaintImage(index, volcanoHoverColor);
            scatter_unpaintImage(index, scatterHoverColor);
        };
    });
    return readJson;
}
